...
df_train = pd.read_csv('/content/drive/MyDrive/ML/ML/TrainingDataMulti.csv', header=None)
...
df_test_orig = pd.read_csv('/content/drive/MyDrive/ML/ML/TestingDataMulti.csv', header=None)
...
df_test_orig.to_csv('TestingResultsMulti.csv', index=False)